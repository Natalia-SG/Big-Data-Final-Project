---
title: "Natalia Sengupta z6063043 Big Data R Code"
...
Activate hyper tibbles. For this section we're using tmp as example. Default: Does not automatically run.
```{r, eval=FALSE}
lon  <- 
...
ggplot(location_data_tmp_total, aes(y = lat, x = lon))+
    ...
    ggtitle("Global Predictability of Temperature") +
...
ggplot(location_data_pre_total, aes(y = lat, x = lon))+
    ...
    ggtitle("Global Predictability of Precipitation") +
    labs(y= "longitude", x = "latitude") +
    scale_colour_viridis_c()
```
...
plot_data_tmp %>%
    ...
    ggtitle("Mean temperature R-squared vs. mean global temperature per biome") +
